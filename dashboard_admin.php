...
<body>
    ...
    <div style="display:flex; min-height:100vh; padding-top:80px;">
        <aside class="admin-sidebar">
            ...
            <button class="admin-nav-btn" onclick="switchAdmin(event, 'sales')">🎟️ Live Box Office</button>
            ...
            <div style="margin-top:auto; padding-top:20px; border-top:1px solid rgba(255,255,255,0.05);">
                <a href="index.php" class="admin-nav-btn" style="color:var(--mocha, #8b7355);"><span
                        style="font-size:1.2rem;">←</span> Exit to Front</a>
            </div>
        </aside>
            ...
            <div id="overview" class="tab-pane active">
                ...
                <div class="stats-grid"
                    ...
                    <div class="stat-card-premium">
                        ...
                        <p style="margin-top:10px; font-size:0.8rem; color:var(--retro-mint, #88c0d0);">↑ 12% from last
                            week</p>
                    </div>
                    <div class="stat-card-premium">
