        ...
        <div class="editorial-right fade-right">
          ...
          <div style="margin-top:40px;">
            ...
            <div class="ticket-tiers">
              <div class="ticket-tier selected" onclick="selectTier(this)"><div><div class="tier-name">Stalls</div><div style="font-size:0.9rem; color:var(--mocha); font-style:italic;">Main level</div></div><div class="tier-price">RM<?= number_format($movie['price'], 2) ?></div></div>
              <div class="ticket-tier" onclick="selectTier(this)"><div><div class="tier-name">Circle</div><div style="font-size:0.9rem; color:var(--mocha); font-style:italic;">Balcony view</div></div><div class="tier-price">RM<?= number_format($movie['price'] * 1.5, 2) ?></div></div>
              <div class="ticket-tier" onclick="selectTier(this)"><div><div class="tier-name">Royal Box</div><div style="font-size:0.9rem; color:var(--mocha); font-style:italic;">Private booth</div></div><div class="tier-price">RM<?= number_format($movie['price'] * 3, 2) ?></div></div>
            </div>
            <button class="btn-coral" style="width:100%; margin-top:25px; background:linear-gradient(135deg, var(--teal-light), var(--teal-deep));" onclick="triggerPageTransition('booking.php?movie_id=<?= $movie['movie_id'] ?>')">Select Seats</button>
          </div>
        </div>
      </div>
    </section>
